# Contributing to Da-Fi DAO

Love Da-Fi DAO and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/Da-Fi/entropyx/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/entropyx.git
    # Navigate to the newly cloned directory
    cd entropyx
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/Da-Fi/entropyx.git
    ```
...
owners to license your work under the terms of the [MIT License](https://github.com/Da-Fi/entropyx/blob/develop/LICENSE.md).
