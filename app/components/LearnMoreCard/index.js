...
const LearnMoreCard = ({
  ...
  return (
    <div tw="flex relative bg-white  rounded-md">
      <div
        tw="h-6 w-6 md:h-8 md:w-8 top-2 right-2 md:top-4 md:right-4 absolute cursor-pointer focus:border-dafidao-blue"
      ...
      <div tw="flex flex-col p-4 md:px-8">
        ...
        {learnMoreHref ? (
          <a
            tw="flex items-center space-x-2 font-sans font-medium text-sm md:text-base hover:text-dafidao-blue"
            href={learnMoreHref}
          >
            <div tw="h-4 w-4">
